    ...
    <div class="table-responsive">
        <table class="table table-striped ">
            ...
            <tbody>
                ...
                @foreach ($hoadonchoxacnhan as $doncho)
                ...
                onclick="showModal('{{ $doncho->ma_hoa_don_ban }}', 'Chờ xác nhận',
                ...
                '{{ $doncho->so_dien_thoai_nguoi_nhan }}', '{{ $doncho->dia_chi_giao_hang }}')">
                    ...
                    <td>
                        <button class="btn btn-success" onclick="xacNhan('{{ $doncho->ma_hoa_don_ban }}', '{{session('userInfo.ma_nhan_vien')}}', event)">Xác nhận</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<script>
    ...
    async function xacNhan(maHoaDon, maNhanVien) {
        event.stopPropagation();

        try {
            const response = await $.ajax({
                type: 'GET',
                url: '{{ route("xac-nhan-don") }}',
                data: {
                    maHoaDon: maHoaDon,
