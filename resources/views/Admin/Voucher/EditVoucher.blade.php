...
@section('Admin_Renderbody')
    ...
    <form class="row g-3 needs-validation" novalidate style="padding: 50px" method="POST"  action="{{ route('Admin.Voucher.update', $Data_Voucher->ma_voucher) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
        
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Mã voucher</label>
            <input type="text" class="form-control" name ='ma_voucher' readonly id="exampleFormControlInput1" value="{{ $Data_Voucher->ma_voucher }}" >
            
        </div>

        <div class="mb-3">
            <label for="exampleFormControlInput2" class="form-label">Tên voucher</label>
            <input type="text" class="form-control" name ='ten_voucher' id="exampleFormControlInput1" value="{{ $Data_Voucher->ten_voucher }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control"  min="0" max="100" name ='phan_tram' id="exampleFormControlInput3" value="{{ $Data_Voucher->phan_tram }}"   required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control"  min="0"  name ='so_luong' id="exampleFormControlInput4" value="{{ $Data_Voucher->so_luong }}"   required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control"   name ='ngay_bat_dau' id="exampleFormControlInput5"  value="{{ \Carbon\Carbon::parse($Data_Voucher->ngay_bat_dau)->format('Y-m-d')}}"  required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control"   name ='ngay_ket_thuc' id="exampleFormControlInput6"  value="{{ \Carbon\Carbon::parse($Data_Voucher->ngay_ket_thuc)->format('Y-m-d') }}"  required>
            <div class="invalid-feedback">
                Bạn cần nhập ngày kêt thúc.
            </div>
        </div>
        <div class="col-12">
