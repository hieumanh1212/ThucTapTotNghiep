...
@section('Admin_Renderbody')
    ...
    <form class="row g-3 needs-validation" novalidate style="padding: 50px" method="POST"  action="{{ route('Admin.NhaCungCap.store') }}" enctype="multipart/form-data">
        @csrf @method('POST')
        
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Mã nhà cung cấp</label>
            <input type="text" class="form-control" name ='ma_nha_cung_cap' readonly id="exampleFormControlInput1" value="{{ $auto_ma_nha_cung_cap }}" >
            
        </div>

        <div class="mb-3">
            <label for="exampleFormControlInput2" class="form-label">Tên nhà cung cấp</label>
            <input type="text" class="form-control" name ='ten_nha_cung_cap' id="exampleFormControlInput1" value="" required>
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control"  name ='email' id="exampleFormControlInput3"   required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control"   name ='so_dien_thoai' id="exampleFormControlInput4"   required>
            <div class="invalid-feedback">
