                        ...
                        <div class="breadcrumb__content p-relative z-index-1">
                           ...
                           <span class="breadcrumb-icon">
                              <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                ...
                                <span><a href="#">{{$product->ten_the_loai}}</a></span>
                                        ...
                                        <!-- @for($i = 0; $i < count($productImages);$i++)
                                            @if($i==0)
                                                <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                                    ...
                                                    <img src="{{url('IMG_SanPham/'.$productImages[$i]->hinh_anh)}}" alt="">
                                                </button>
                                            @else
                                                <button class="nav-link" id="nav-{{$i+1}}-tab" data-bs-toggle="tab"
                                                        data-bs-target="#nav-{{$i+1}}" type="button" role="tab"
                                                        aria-controls="nav-{{$i+1}}" aria-selected="false">
                                                    <img src="{{url('IMG_SanPham/'.$productImages[$i]->hinh_anh)}}" alt="">
                                                </button>
                                            @endif
                                        @endfor -->
                                        ...
                                        @if($i==0)
                                            <div class="tab-pane fade active show" id="nav-1" role="tabpanel"
                                                ...
                                                <div class="tp-product-details-nav-main-thumb">
                                                    <img src="{{url('IMG_SanPham/'.$productImages[$i]->hinh_anh)}}" alt=""
                                                         style="width: 580px;height: 670px;">
                                                </div>
                                            </div>
                                        @else
                                            <div class="tab-pane fade" id="nav-{{$i+1}}" role="tabpanel"
                                                 aria-labelledby="nav-{{$i+1}}-tab" tabindex="0">
                                                <div class="tp-product-details-nav-main-thumb">
                                                    <img src="{{url('IMG_SanPham/'.$productImages[$i]->hinh_anh)}}" alt=""
                                                         style="width: 580px;height: 670px;">
                                                </div>
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="tp-product-details-wrapper">
                                <div class="tp-product-details-category">
                                    <span>{{$product->ten_the_loai}}</span>
                                </div>
                                <h3 class="tp-product-details-title">{{$product->ten_san_pham}}</h3>
...
{{--                                </div>--}}
                                    ...
                                    <div class="tp-product-details-variation-item">
                                        ...
                                        <div class="tp-product-details-variation-list">
                                            @foreach($colors as $color)
                                                <button type="button" id="color{{$color->ma_mau}}"
                                                        class="color tp-color-variation-btn"
                                                        onclick="checkSize({{$sizesLeft->get($color->ma_mau)}},{{$sizes}})">
                                                    <span data-bg-color="#{{$color->ma_mau}}"
                                                          style="background-color: {{$color->ma_mau}};"></span>
                                                    <span class="tp-color-variation-tootltip">{{$color->mau}}</span>
                                                </button>
                                            @endforeach
                                        </div>
                                    </div>
                                       ...
                                       <span class="tp-cart-minus">
                                          <svg width="11" height="2" viewBox="0 0 11 2" fill="none"
                                             ...
                                             <path d="M1 1H10" stroke="currentColor" stroke-width="1.5"
                                                ...
                                                <label>
                                                    <input id="quantity" class="tp-cart-input" type="text" value="1"
                                                           min="1" max="100">
                                                </label>
                                ...
                                <div class="tp-product-details-action-sm">
                                    ...
                                    <button type="button" class="tp-product-details-action-sm-btn" onclick="addToWishlist('{{$product->ma_san_pham}}',{{$sizes}},{{$colors}})">
                                ...
                                <div
                                    ...
                                    <img src="{{url('assets/img/product/icons/payment-option.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="tp-section-title-wrapper-6 text-center mb-40">
                        <span class="tp-section-title-pre-6">Sản phẩm</span>
                ...
                <div class="row">
                    <div class="tp-product-related-slider">
                        <div
                            class="tp-product-related-slider-active swiper-container mb-10 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-be1feaeab7aaf0fa" aria-live="polite"
                                 style="transform: translate3d(-960px, 0px, 0px); transition-duration: 0ms;">
                                @foreach($relatedProducts as $relatedProduct)
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6" style="margin-right: 24px;">
                                        <div class="tp-product-item-2 mb-40">
                                            <div class="tp-product-thumb-2 p-relative z-index-1 fix w-img">
                                                <a href="{{url('product-detail/'.$relatedProduct->ma_san_pham)}}">
                                                    <img src="{{url('IMG_SanPham/'.$relatedProduct->anh_dai_dien)}}" alt="">
                                                </a>
                                                <!-- product action -->
                                                <div class="tp-product-action-2 tp-product-action-blackStyle">
                                                    <div class="tp-product-action-item-2 d-flex flex-column">
                                                        <button type="button"
                                                            ...
                                                            <span class="tp-product-tooltip tp-product-tooltip-right">Thêm vào giỏ hàng</span>
                                                        </button>
                                                        <button type="button"
                                            ...
                                            <div class="tp-product-content-2 pt-15">
                                                ...
                                                <h3 class="tp-product-title-2">
                                                    <a href="{{url('product-detail/'.$relatedProduct->ma_san_pham)}}">{{$relatedProduct->ten_san_pham}}</a>
                                                </h3>
                                                ...
                                                <div class="tp-product-price-wrapper-2">
                                                    <span class="tp-product-price-2 new-price">{{ number_format($product->don_gia_ban-$product->giam_gia, 0, ',', '.') }}đ</span>
                                ...
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next"
                                     role="group" aria-label="6 / 12" data-swiper-slide-index="1"
                                     style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate" role="group" aria-label="7 / 12"
                                     data-swiper-slide-index="2" style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" role="group"
                                     aria-label="8 / 12" data-swiper-slide-index="3"
                                     style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="5 / 12"
                                     data-swiper-slide-index="0" style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="6 / 12"
                                     data-swiper-slide-index="1" style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide" role="group" aria-label="7 / 12" data-swiper-slide-index="2"
                                     style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate-prev" role="group" aria-label="8 / 12"
                                     data-swiper-slide-index="3" style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active"
                                     role="group" aria-label="5 / 12" data-swiper-slide-index="0"
                                     style="width: 296px; margin-right: 24px;">
                                </div>
                                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next"
                                     role="group" aria-label="6 / 12" data-swiper-slide-index="1"
                        ...
                        <div class="tp-related-swiper-scrollbar tp-swiper-scrollbar">
                            <div class="tp-swiper-scrollbar-drag"
                                 style="transform: translate3d(254.686px, 0px, 0px); transition-duration: 0ms; width: 155.018px;"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="tp-product-modal-content d-lg-flex align-items-start">
                        ...
                        <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                            <nav>
                                <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                    <button class="nav-link active" id="nav-1-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="true">
                                        <img src="{{url('assets/img/product/details/nav/product-details-nav-1.jpg')}}"
                                             alt="">
                                    </button>
                                    <button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2"
                                        ...
                                        <img src="{{url('assets/img/product/details/nav/product-details-nav-2.jpg')}}"
                                             alt="">
                                    </button>
                                    <button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3"
                                        ...
                                        <img src="{{url('assets/img/product/details/nav/product-details-nav-3.jpg')}}"
                                             alt="">
                                    </button>
                                    <button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4"
                                        ...
                                        <img src="{{url('assets/img/product/details/nav/product-details-nav-4.jpg')}}"
                                             alt="">
                                    </button>
                                </div>
                            </nav>
                            <div class="tab-content m-img" id="productDetailsNavContent">
                                <div class="tab-pane fade show active" id="nav-1" role="tabpanel"
                                     aria-labelledby="nav-1-tab" tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{url('assets/img/product/details/main/product-details-main-1.jpg')}}"
                                             alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab"
                                     tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{url('assets/img/product/details/main/product-details-main-2.jpg')}}"
                                             alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab"
                                     tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{url('assets/img/product/details/main/product-details-main-3.jpg')}}"
                                             alt="">
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab"
                                     tabindex="0">
                                    <div class="tp-product-details-nav-main-thumb">
                                        <img src="{{url('assets/img/product/details/main/product-details-main-4.jpg')}}"
                                             alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tp-product-details-wrapper">
                            ...
                            <!-- price -->
                            <div class="tp-product-details-price-wrapper mb-20">
                                <span class="tp-product-details-price old-price">{{ number_format($product->don_gia_ban, 0, ',', '.') }}đ</span>
                                <span class="tp-product-details-price new-price">{{ number_format($product->don_gia_ban-$product->giam_gia, 0, ',', '.') }}đ</span>
                            </div>
                                    ...
                                    <div class="tp-product-details-variation-list">
                                        <button type="button" class="color tp-color-variation-btn">
                                            <span data-bg-color="#F8B655"
                                                  style="background-color: rgb(248, 182, 85);"></span>
                            ...
                            <div class="tp-product-details-action-wrapper">
                                ...
                                <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                                    ...
                                    <div class="tp-product-details-add-to-cart mb-15 w-100">
                                        <button class="tp-product-details-add-to-cart-btn w-100" onclick="">Add To
                                            Cart
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="tp-product-details-action-sm">
                                ...
                                <button type="button" class="tp-product-details-action-sm-btn" onclick="">
                                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              d="M2.33541 7.54172C3.36263 10.6766 7.42094 13.2113 8.49945 13.8387C9.58162 13.2048 13.6692 10.6421 14.6635 7.5446C15.3163 5.54239 14.7104 3.00621 12.3028 2.24514C11.1364 1.8779 9.77578 2.1014 8.83648 2.81432C8.64012 2.96237 8.36757 2.96524 8.16974 2.81863C7.17476 2.08487 5.87499 1.86999 4.69024 2.24514C2.28632 3.00549 1.68259 5.54167 2.33541 7.54172ZM8.50115 15C8.4103 15 8.32018 14.9784 8.23812 14.9346C8.00879 14.8117 2.60674 11.891 1.29011 7.87081C1.28938 7.87081 1.28938 7.8701 1.28938 7.8701C0.462913 5.33895 1.38316 2.15812 4.35418 1.21882C5.7492 0.776121 7.26952 0.97088 8.49895 1.73195C9.69029 0.993159 11.2729 0.789057 12.6401 1.21882C15.614 2.15956 16.5372 5.33966 15.7115 7.8701C14.4373 11.8443 8.99571 14.8088 8.76492 14.9332C8.68286 14.9777 8.592 15 8.50115 15Z"
...
@section('scripts')
    <script>
        function checkSize(sizesLeft, sizes) {
            let arraySize = [];
            for (let i = 0; i < sizes.length; i++) {
                $('#size' + sizes[i].size).removeClass('active');
                arraySize.push(sizes[i].size);
            }
            let arraySizeLeft = [];
            for (let i = 0; i < sizesLeft.length; i++) {
                arraySizeLeft.push(sizesLeft[i].size);
            }
            for (let i = 0; i < arraySize.length; i++) {
                if (arraySizeLeft.includes(arraySize[i])) {
                    $('#size' + arraySize[i]).removeAttr('disabled');
                    $('#size' + arraySize[i]).css('color', 'red');
                } else {
                    $('#size' + arraySize[i]).attr('disabled', true);
                    $('#size' + arraySize[i]).css('color', 'gray');
                }
            }
        }
