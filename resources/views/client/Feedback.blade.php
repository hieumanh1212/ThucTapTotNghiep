...
@section('content')
    <main>
        @if(session()->has('message'))
            <script>swal.fire('Bạn đã gửi feedback thành công','success');</script>
        @endif
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8">
                            <div class="tp-contact-wrapper">
                                <h3 class="tp-contact-title">Gửi phản hồi</h3>
                                            ...
                                            <div class="tp-contact-input-box">
                                                <div class="tp-contact-input">
                                                    <textarea id="message" name="message"
                                                              placeholder="Gửi phản hồi cho chúng tôi..."></textarea>
                                                </div>
                                                <div class="tp-contact-input-title">
                                ...
                                <div class="tp-contact-info-item">
                                 ...
                                 <span>
                                    ...
                                    <div class="tp-contact-info-content">
                                        <p data-info="mail"><a href="mailto:contact@shofy.com">Nhom07BTLCNPM@gmail.com</a></p>
                                        <p data-info="phone"><a href="tel:670-413-90-762">+ 0912345678</a></p>
                                    </div>
                                </div>
                                <div class="tp-contact-info-item">
                                    <div class="tp-contact-info-icon">
                                    ...
                                    <div class="tp-contact-info-content">
                                        <p>
                                            <a href="https://www.google.com/maps/place/New+York,+NY,+USA/@40.6976637,-74.1197638,11z/data=!3m1!4b1!4m6!3m5!1s0x89c24fa5d33f083b:0xc80b8f06e177fe62!8m2!3d40.7127753!4d-74.0059728!16zL20vMDJfMjg2"
                                               target="_blank">
                                                Số 3 Cầu Giấy <br> Láng Thượng,Hà Nội
                                            </a>
                                        </p>
                                    </div>
                                </div>
    ...
    <script>
        function validateForm() {
            ...
            if(name.val()===""||name.val()===null){
                sweetAlert('Không đuợc để họ tên trống!','error');
                return false;
            }
            if(phoneNumber.val()===""||phoneNumber.val()===null){
                sweetAlert('Không đuợc để số điện thoại trống!','error');
                return false;
            }
            if(email.val()===""||email.val()===null){
                sweetAlert('Không đuợc để email trống!','error');
                return false;
            }
            if(message.val()===""||message.val()===null){
                sweetAlert('Không đuợc để nội dung trống!','error');
                return false;
            }
            sweetAlert('Bạn đã gửi thành công!','success');
            return true;
        }
    </script>
@endsection
