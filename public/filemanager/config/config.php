...
$config = array(
    ...
    */
    ...
    'base_url' => '', // cát bỏ đường dẫn máy chủ
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    //'upload_dir' => '/IMG_SanPham/',
    'upload_dir' => '',// đẻ cắt bỏ đi đường dẫn folder chỉ lấy tên ảnh
    /*
    |--------------------------------------------------------------------------
